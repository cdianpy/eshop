# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-12-11 08:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('0', '新订单'), ('1', '未付款'), ('2', '已付款'), ('3', '已发货'), ('4', '交易成功')], default='0', max_length=2)),
                ('remark', models.TextField(blank=True, null=True)),
                ('price', models.DecimalField(decimal_places=2, max_digits=12)),
                ('quantity', models.PositiveIntegerField(default=1)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('adderss', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_address', to='computerapp.DeliveryAddress')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
